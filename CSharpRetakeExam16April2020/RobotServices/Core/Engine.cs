            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (input[0] == "Manufacture")
                    {
                        ...
                        result = controller.Manufacturer(robotType, name, energy, happiness, procedureTime);
                    }
                    ...
                    else if (input[0] == "Change")
                    {
                        string name = input[1];
                        int procedureTime = int.Parse(input[2]);
                        result = controller.Change(name, procedureTime);
                    }
                    ...
                    {
                        string procerureType = input[1];
                        result = controller.Hystory(procerureType);
                    }
